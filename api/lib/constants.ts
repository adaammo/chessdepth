...
export const CHESS_URL_ARCHIVES_PREFIX = (username: string) => {
    return `https://api.chess.com/pub/player/${username}/games`
}
export const CHESS_API_HEADERS = {
    "User-Agent": "ChessDepth/1.0 (contact: adaam.mohamed31@gmail.com",
